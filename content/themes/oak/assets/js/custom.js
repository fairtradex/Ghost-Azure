(function ($) {
    ...
    $(".oak-navigation-button").on("click", function() { 
        ...
        $(".oak-navigation-button").toggleClass('ion-navicon-round ion-close-round'); 
    });

    $(".oak-search").on("keyup", function () {
        if($('.oak-search').val().length > 0) {
            $('.oak-post-search').addClass('oak-post-search-active');
        }
        else {
            $('.oak-post-search').removeClass('oak-post-search-active'); 
        }
    });

    $(".oak-search").on("focusin", function () {
        if($('.oak-search').val().length > 0) {
            $('.oak-search').keyup();
        }
    });
    ...
    $(document).click(function(event) { 
        if(!$(event.target).closest('.oak-post-search').length) {
            $('.oak-post-search').removeClass('oak-post-search-active');
        }        
    });

    $(".oak-search-icon").on("click", function() {
        $(".oak-search").focus();
    });

    $(".oak-search").ghostHunter({
        results : ".oak-search-results",
